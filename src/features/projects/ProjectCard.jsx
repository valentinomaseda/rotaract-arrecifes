...
// Se espera que el prop 'project' tenga: { id, title, description, imageUrl, date }
export const ProjectCard = ({ project, index = 0 }) => {
  ...
  return (
    <article
      ref={ref}
      className={`group flex flex-col bg-white rounded-2xl overflow-hidden card-hover border border-gray-100/80 transition-all duration-700 ${
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-6">
        ...
        {/* Bottom accent line */}
        <div className="mt-5 h-0.5 w-8 bg-cranberry/30 rounded-full group-hover:w-full transition-all duration-500 ease-out" />
      </div>
    </article>
  );
};